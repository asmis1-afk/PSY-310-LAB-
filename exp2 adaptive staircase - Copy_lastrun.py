...
expName = 'exp2 adaptive staircase'  # from the Builder filename that created this script
expVersion = ''
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\samki\\Desktop\\exp2 adaptive staircase - Copy_lastrun.py',
